...
Hoje revisamos conceitos que serão a base de praticamente toda a disciplina.

Nas próximas aulas começaremos a criar algoritmos cada vez mais elaborados.

Nosso objetivo não será decorar comandos.

Nosso objetivo será aprender a olhar para um problema e pensar:

> **Como eu poderia transformar isso em um algoritmo?**
